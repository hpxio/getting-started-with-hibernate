...
package com.app.rc.GettingStartedWithHibernate.usingXmlConfiguration.configuration;
...
/**
 * FIXME: Properties are not bound during runtime.
 * 
 * @author iHSPA
 */
@Configuration
...
public class DatabaseConfigurations {
    ...
    public String toString ( ) {
        return "DatabaseConfigurations [DRIVER=" + DRIVER
                + ", PASSWORD=" + PASSWORD + ", URL=" + URL
                + ", USERNAME=" + USERNAME + ", DIALECT="
                + DIALECT + ", SHOW_SQL=" + SHOW_SQL
